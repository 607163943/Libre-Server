...
import com.libre.pojo.dto.admin.ModuleDTO;
import com.libre.pojo.dto.admin.ModulePageDTO;
import com.libre.pojo.po.Module;
import com.libre.pojo.vo.admin.ModulePageVO;
...
public class AdminModuleServiceImpl extends ServiceImpl<ModuleMapper, Module> implements AdminModuleService {
    ...
    public void addModule(ModuleDTO moduleDTO) {
        ...
        if (moduleCount > 0) {
            throw new ModuleException(ExceptionEnums.MODULE_EXIST);
        }
